...
if ('0'==$_POST['laporan']) {
	...
	$select = "SELECT id AS 'ID', nama AS 'NAMA', tinggi AS 'TINGGI BADAN', berat AS 'BERAT BADAN', ortu AS 'PEKERJAAN ORANG TUA', penyakit AS 'RIWAYAT PENYAKIT', jurusan AS 'JURUSAN', tahun AS 'TAHUN LULUS', cita AS 'CITA - CITA', status AS 'STATUS SETELAH LULUS' FROM alumni";
}
