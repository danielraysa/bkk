...
if( isset($_POST['submit'])) {
	...
	if ($b!='' and $c!='' and $d!='') {
		$q = "INSERT INTO berita VALUES (null, CURDATE(), '$b', '$d', '$c')";
...
<form method='POST' onSubmit="return submitForm('<?=$_SERVER['PHP_SELF'];?>')">
        <table class="loginform" width="100%" border="0" cellpadding="4" cellspacing="4">
		  ...
		  <tr> 
            <td>Isi Berita</td>
            <td><textarea id="posting" name="posting"></textarea>
		  ...
		  <tr> 
            <td>Tgl Hapus</td>
            <td><input type="text" id="datepicker1" name='c' size=10></td>
          </tr>
          <tr> 
