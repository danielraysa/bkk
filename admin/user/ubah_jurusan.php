...
if( isset($_POST['submit'])) {
	...
	if ($b!='') {
		$q = "UPDATE jurusan SET nama = '".$b."' WHERE id = '".$_GET['id']."'";
	...
	$q1 = "SELECT * FROM jurusan WHERE id = '".$_GET['id']."'";
...
<h2><b>Edit Jurusan</B></H2><BR>
<form method='POST' onSubmit="return submitForm('<?=$_SERVER['PHP_SELF'];?>')">
        <table class="loginform" width="150%" border="0" cellpadding="4" cellspacing="4">
		  <tr> 
            <td width='15%'>Nama Jurusan</td>
